<template>
    ...
    <div class="container flex flex-wrap items-center justify-between mx-auto">
      <p>
        <select
          ...
          class="border w-26 h-12 dark:bg-gray-800 dark:text-white dark:border-white rounded-lg font-peyda"
        >
          <option value="system">
            مطابق سیستم
          </option>
      ...
      <div id="navbar-default" class="hidden w-full md:block md:w-auto">
        <ul
          class="flex flex-col p-4 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row  ltr:md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700 rtl"
        >
          <li class="mx-2">
            <nuxt-link
              to="/"
              class="block py-2 pl-4 pr-4 text-lg text-gray-700 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-gray-400 md:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent"
            >
              خانه
            </nuxt-link>
          </li>
  ...
  <div class="max-w-2xl p-0 md:p-4 mx-auto">
    ...
    <div id="drawer-navigation" class="fixed top-0 left-0 z-40 h-screen p-4 overflow-y-auto transition-transform -translate-x-full bg-white w-80 dark:bg-gray-800" tabindex="-1" aria-labelledby="drawer-navigation-label">
      <h5 id="drawer-navigation-label" class="text-base font-semibold text-gray-500 uppercase dark:text-gray-400 text-start">
        منو
      </h5>
      <button type="button" data-drawer-hide="drawer-navigation" aria-controls="drawer-navigation" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 absolute top-2.5 left-2.5 inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white " @click="closeDrawer">
...
export default defineComponent({
  setup () {
    ...
    const openWindow = () => {
      window.open('https://github.com/mmshooreshi')
      drawer.value.hide()
    }
